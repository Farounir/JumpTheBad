...
custChar MAN_A = {0xe,0xe,0x4,0xe,0x15,0xe,0x1b,0x00}; //standing man
const uint8_t MAN = 0;

custChar MAN_JUMP_A = {0xe,0xe,0x5,0xe,0x14,0xe,0x12,0x00}; //starting to jump
const uint8_t MAN_JUMP = 1;

custChar MAN_TOP_A = {0xe,0xe,0x15,0xe,0x4,0xe,0x11,0x00};  //spread eagle
const uint8_t MAN_TOP= 2;

custChar MAN_LAND_A = {0xe,0xe,0x14,0xe,0x5,0xe,0x9,0x00}; //we have landing
const uint8_t MAN_LAND = 3;

custChar OBS_A = {0x0,0x0,0x4,0xa,0x15,0xa,0x15,0x00};  //generic obstical
const uint8_t OBS = 4;

custChar MAN_DEAD_A = {0x0,0x0,0x0,0x0,0x18,0x19,0x1f,0x00};  //its dead Jim
